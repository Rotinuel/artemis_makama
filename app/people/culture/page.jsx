...
export const metadata = {
  title: 'Culture - HOK',
  description: "HOK's warm, collaborative studio culture across 27 offices worldwide.",
}
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          {galleries.map((img, i) => (
            <div key={i} className="overflow-hidden" style={{ aspectRatio: '4/3' }}>
              <img src={img} alt="HOK culture" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
            </div>
          ))}
        </div>
      </section>
        ...
        <div className="max-w-[1600px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-[15px] text-[#aaa] leading-relaxed mb-8 font-light">
              HOK is committed to building a diverse and inclusive workforce. We believe that diverse teams produce better design solutions and are dedicated to creating an environment where every person can thrive.
            </p>
          ...
          <div style={{ aspectRatio: '4/3' }} className="overflow-hidden">
            <img src="https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?w=900&q=80" alt="DEI at HOK" className="w-full h-full object-cover" />
          </div>
        </div>
      </section>
