...
//
// const markets = [
//     'Aviation + Transportation', 'Civic + Justice', 'Corporate + Commercial',
//     'Federal Government', 'Healthcare', 'Higher Education', 'Lifestyle',
//     'Mixed-Use', 'Renovation + Refurbishment', 'Science + Technology',
//     'Sports + Rec + Entertainment',
// ]
//
// const disciplines = [
...
// ]
//
// // Scroll distance over which the animation plays out
// const SCROLL_THRESHOLD = 120
//
...
//
//     // The nav starts centered (top: 50vh, translateY: -50%)
//     // As we scroll it travels upward — we animate translateY from -50vh offset toward -50vh - 50vh = -100vh
//     // then the compact bar takes over. We express the vertical shift in vh.
//     const heroTranslateY = -(progress * 55)   // vh: slides upward
//     const heroScale      = 1 - progress * 0.4 // 1 → 0.6
//     const heroOpacity    = 1 - progress * 1.6  // fully faded before threshold
//
//     return (
//         <>
//             {/* ─────────────────────────────────────────────────────────────
//           HERO NAV — centered vertically, slides up on scroll
//       ───────────────────────────────────────────────────────────── */}
//             <div
//                 aria-hidden={scrolled}
//                 className="hero-nav-wrap"
...
//                     pointerEvents: scrolled ? 'none' : 'auto',
//                     // translateY(-50%) centers it; additional heroTranslateY slides it upward
//                     transform: `translateY(calc(-50% + ${heroTranslateY}vh)) scale(${heroScale})`,
...
//
//             {/* ─────────────────────────────────────────────────────────────
//           HERO CORNER UTILITIES — logo + search + lang (fade out)
//       ───────────────────────────────────────────────────────────── */}
//             <div
//                 aria-hidden={scrolled}
//                 style={{
...
//
//             {/* ─────────────────────────────────────────────────────────────
//           SCROLLED TOP BAR — slides down from top after threshold
//       ───────────────────────────────────────────────────────────── */}
//             <header
//                 style={{
//                     position: 'fixed',
...
//                     <div style={{ flex: 1 }}>
//                         <button
//                             onClick={() => setProjectsTab('markets')}
//                             style={{ fontSize: 10, textTransform: 'uppercase', letterSpacing: '0.15em', fontWeight: 600, marginBottom: 16, color: projectsTab === 'markets' ? '#1a1a1a' : '#888', background: 'none', border: 'none', borderBottom: `2px solid ${projectsTab === 'markets' ? '#1a1a1a' : 'transparent'}`, paddingBottom: 8, cursor: 'pointer', width: '100%', textAlign: 'left', fontFamily: 'sans-serif' }}
//                         >Markets</button>
//                         {projectsTab === 'markets' && (
//                             <ul style={{ listStyle: 'none', margin: 0, padding: 0 }}>
//                                 {markets.map(m => (
//                                     <li key={m}>
//                                         <Link href="/projects" style={{ fontSize: 13, color: '#1a1a1a', textDecoration: 'none', display: 'block', padding: '4px 0' }}
...
//                     <div style={{ flex: 1 }}>
//                         <button
//                             onClick={() => setProjectsTab('disciplines')}
//                             style={{ fontSize: 10, textTransform: 'uppercase', letterSpacing: '0.15em', fontWeight: 600, marginBottom: 16, color: projectsTab === 'disciplines' ? '#1a1a1a' : '#888', background: 'none', border: 'none', borderBottom: `2px solid ${projectsTab === 'disciplines' ? '#1a1a1a' : 'transparent'}`, paddingBottom: 8, cursor: 'pointer', width: '100%', textAlign: 'left', fontFamily: 'sans-serif' }}
//                         >Disciplines</button>
//                         {projectsTab === 'disciplines' && (
//                             <ul style={{ listStyle: 'none', margin: 0, padding: 0 }}>
//                                 {disciplines.map(d => (
...
//                 </div>
//                 <div style={{ marginTop: 20, paddingTop: 16, borderTop: '1px solid #e5e5e5' }}>
//                     <Link href="/projects/stories" style={{ fontSize: 12, textTransform: 'uppercase', letterSpacing: '0.1em', fontWeight: 600, color: '#1a1a1a', textDecoration: 'none' }}>
//                         Project Stories →
//                     </Link>
//                 </div>
//             </div>
...
//             {links.map(item => (
//                 <li key={item.label}>
//                     <Link href={item.href} style={{ fontSize: 13, color: '#1a1a1a', textDecoration: 'none', display: 'block', padding: '5px 0' }}
//                           onMouseEnter={e => e.currentTarget.style.color = '#888'}
//                           onMouseLeave={e => e.currentTarget.style.color = '#1a1a1a'}
//                     >{item.label}</Link>
//                 </li>
...
//                   fontFamily="'Helvetica Neue', Helvetica, Arial, sans-serif"
//                   fontSize="20" fontWeight="700" fill={isWhite ? '#07ba93' : 'white'} letterSpacing="-0.5"
//             >AA</text>
//         </svg>
//     )
// }
...
//
// const iconBtn = (color) => ({
//     color, background: 'none', border: 'none', cursor: 'pointer', padding: 4, display: 'flex', alignItems: 'center',
// })
//
